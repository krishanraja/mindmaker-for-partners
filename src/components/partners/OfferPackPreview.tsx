      ...
      <Card className="shadow-sm border rounded-xl bg-gradient-to-br from-primary/10 via-primary/5 to-accent/10 border-primary/20">
        <CardContent className="p-6 space-y-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="font-bold text-foreground">AI-Powered Strategic Insights</h3>
            <Badge variant="secondary" className="ml-auto text-xs">Tailored Analysis</Badge>
          </div>
          ...
          <p className="text-xs text-muted-foreground italic mt-4">
            Generated by AI based on your portfolio data, sector patterns, and readiness signals.
          </p>
        </CardContent>
      </Card>
